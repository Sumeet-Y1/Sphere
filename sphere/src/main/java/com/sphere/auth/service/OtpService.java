                              ...
                              <table width="100%%" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.05);border-radius:11px;padding:16px 20px;">
                                    <table width="100%%" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="20" style="vertical-align:top;padding-top:1px;"><span style="font-size:13px;">⏱</span></td>
                                        <td style="padding-left:8px;">
                                          <p style="margin:0;color:rgba(255,255,255,0.3);font-size:13px;line-height:1.5;">Code expires in <strong style="color:rgba(255,255,255,0.65);font-weight:500;">10 minutes</strong>. Do not share it with anyone.</p>
                                        </td>
                                      </tr>
                                    </table>
                                    ...
                                    <table width="100%%" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="20" style="vertical-align:top;padding-top:1px;"><span style="font-size:13px;">🔒</span></td>
                                        <td style="padding-left:8px;">
                                          <p style="margin:0;color:rgba(255,255,255,0.22);font-size:12px;line-height:1.55;">If you didn't request this, you can safely ignore this email. Your account is secure.</p>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                    ...
                    <tr>
                      <td align="center">
                        <table width="540" cellpadding="0" cellspacing="0" class="email-card" style="background-color:#0d0d0d;border-radius:20px;border:1px solid rgba(255,255,255,0.07);overflow:hidden;">
                          ...
                          <tr>
                            <td class="email-pad" style="padding:44px 40px 40px;">
                              <h2 style="margin:0 0 10px;color:#ffffff;font-size:22px;font-weight:600;letter-spacing:-0.02em;line-height:1.3;">Reset your password</h2>
                              <p style="margin:0 0 36px;color:rgba(255,255,255,0.32);font-size:14px;line-height:1.75;">
                                We received a request to reset your Sphere password. Use the code below to proceed. This code is valid for <span style="color:rgba(255,255,255,0.6);font-weight:500;">10 minutes</span>.
                              </p>
                              <table width="100%%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                                <tr>
                                  <td class="otp-box" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.09);border-radius:16px;padding:32px 24px;text-align:center;">
                                    <p style="margin:0 0 16px;color:rgba(255,255,255,0.25);font-size:10px;text-transform:uppercase;letter-spacing:0.22em;font-family:Helvetica,Arial,sans-serif;">Password Reset Code</p>
                                    <p class="otp-code" style="margin:0;color:#ffffff;font-size:52px;font-weight:700;letter-spacing:16px;font-family:Georgia,'Times New Roman',serif;line-height:1;text-indent:16px;">%s</p>
                                    <div style="width:56px;height:1px;background:rgba(255,255,255,0.14);margin:20px auto 0;"></div>
                                  </td>
                                </tr>
                                  ...
                                  <td style="background:rgba(255,255,255,0.02);border:1px solid rgba(255,255,255,0.05);border-radius:11px;padding:16px 20px;">
                                    ...
                                    <table width="100%%" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="20" style="vertical-align:top;padding-top:1px;"><span style="font-size:13px;">🔒</span></td>
                                        <td style="padding-left:8px;">
                                          <p style="margin:0;color:rgba(255,255,255,0.22);font-size:12px;line-height:1.55;">If you didn't request a password reset, ignore this email. Your account remains secure.</p>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
